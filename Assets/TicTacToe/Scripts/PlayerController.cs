...
public class PlayerController : MonoBehaviour
{
    ...
    public GameObject horizontalLine1;
    public GameObject horizontalLine2;
    public GameObject horizontalLine3;
    public GameObject verticalLine1;
    public GameObject verticalLine2;
    public GameObject verticalLine3;
    ...
    public void ResetGame()
    {
        ...
        horizontalLine3.SetActive(false);
        verticalLine1.SetActive(false);
        verticalLine2.SetActive(false);
        verticalLine3.SetActive(false);
